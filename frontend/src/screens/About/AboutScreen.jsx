...
const PIPELINE_STEPS = [
  ...
  {
    name: 'LLM phrasing',
    note: "A small LLM (Gemma-3-270M-it, bundled into the app and run entirely on-device via llama.cpp/WASM) turns the grounded facts into a clear, conversational answer tailored to the user's role — it never invents numbers the Grounding Layer didn't supply, and needs no network or API key to run. A rule-based check catches incoherent output from a model this small and falls back to a plain grounded sentence instead.",
  },
]
